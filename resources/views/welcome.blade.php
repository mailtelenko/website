...
-->
    <div class="landing container-fluid" style="height:100vh; background-image: url({{asset('/img/landingImage.jpg')}}">
        <div class="row">
            <div class="col-sm-12 col-md-4 welcomeBox">
                <h1>Liam<br/>Telenko.</h1>
                <hr/>
                <marquee>
                <h3>Developer</h3>
                </marquee>
